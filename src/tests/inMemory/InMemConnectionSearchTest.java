...
public class InMemConnectionSearchTest {
    ...
    private void setup_lines_segments_stops() {
        ...
        stops.put(new StopName("Zastavka2"), new ArrayList<>() {{
            add(new LineName("1"));
            add(new LineName("2"));
        }});
        stops.put(new StopName("Zastavka3"), new ArrayList<>() {{
            add(new LineName("1"));
        }});
        ...
        stops.put(new StopName("Zastavka4"), new ArrayList<>() {{
            add(new LineName("2"));
        }});
    }
